...
import PRL614Q from "../pages/PRL614Q";
import logger from "../logging/logger";
import PRL300Q from "../pages/PRL300Q";
...
test.describe("BACS Run " + `${process.env.test_env}`.toUpperCase(), () => {
    //Test case 1
    test.fixme("BACS Payment Run", async ({ page }, testInfo) => {
        ...
        //                     Math.floor(
        //                         Math.random() * InvoiceCalc.costCentreArr.length
        //                     )
        //                 ];
        ...
        //             const vatAmount =
        //                 Math.round(((netInvoice * vatPercent) / 100) * 100) /
        //                 100;
        ...
        //                       }).format(Number(vatAmount.toFixed(2)))
        //                     : "0.00"
        //             );
